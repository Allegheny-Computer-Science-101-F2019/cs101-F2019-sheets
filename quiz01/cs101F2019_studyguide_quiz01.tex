...
\begin{itemize}
  ...
  % Move these chapters to the examination
  ...
  \item Using the commands in the terminal window (e.g., \command{docker} and
    \command{cd}); building and running Java programs with Gradle; knowledge of
...
\begin{itemize}
  ...
  \item Basic syntax (i.e., structure) and semantics (i.e., meaning) of the Java
    programming language

  \item Input(s) and output(s) of the Java compiler and virtual machine, as run
    in Docker containers

  \item How to use \command{gradle} in a Docker container to build, run, and
    grade a Java program

  \item The base types available for primitive variables in Java (e.g.,
    \program{int} and \program{char} and \program{double})
  ...
  \item The purpose, declaration, and use of \program{String},
    \program{StringBuffer}, and arrays

  \item Type conversion operators (e.g., casting) and control flow constructs
    (e.g., conditional logic)
...
\begin{itemize}
  ...
  \item How and why to use arrays to store primitive and reference variables

  \item The limitations associated with using an array to store multiple data
    values
  ...
  \item How to effectively implement and test a sorting algorithm like the
    one called insertion sort

  \item How to declare and use psuedo-random number generators in a Java program
  ...
  \item The meaning and purpose of different techniques for ``cloning'' data
