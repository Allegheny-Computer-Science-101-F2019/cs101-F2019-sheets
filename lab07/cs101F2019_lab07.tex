...
\begin{enumerate}
  ...
  \item For the chosen input sizes in the results table, which strategy is
    faster? How can you tell?
  ...
  \item Why is it not possible to run one of the Fibonacci computation
    algorithms for certain inputs?
