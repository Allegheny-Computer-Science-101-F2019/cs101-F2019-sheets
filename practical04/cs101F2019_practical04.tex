...
assignment. Additionally, to review how to use the your operating system and
software development programs such as a ``terminal window'' and ``Docker
...
with a name like
``Allegheny-Computer-Science-101-Fall-2019/computer-science-101-fall-2019-practical-3-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-101-F2019/computer-science-101-fall-2019-practical-3-gkapfham.git
\end{lstlisting}
...
discoveries with a neighbor and a \mbox{technical leaders}.
...
\program{java.lang.ArrayIndexOutOfBoundsException}, as shown in the following
output segment. This means that you will have to examine the source code of
\mainprogram{} to determine what mistakes are lurking in its implementation.
Please notice that the two sorting methods --- one for type {\tt char} and
another for type {\tt int} --- contain several (different) mistakes that you
should incrementally fix. Reading about \mainprogram{} on Wikipedia and
reasoning about how the current implementation does not match the algorithm's
expected behavior, which must perform a type of ``swap'', should help you to
find and repair the defects. How will you know when the program is correct? If
you are stuck, please talk to a technical leader or the instructor.

\begin{verbatim}
  > Task :run FAILED
  Before: [C, E, B, D, A, I, J, L, K, H, G, F]
  Exception in thread "main" java.lang.ArrayIndexOutOfBoundsException: 12
          at practicalthree.BubbleSort.sort(BubbleSort.java:29)
          at practicalthree.BubbleSort.main(BubbleSort.java:70)
...
check your program for errors and get it ready to run. If you see any error
messages, go back to your text editor and figure out what is still incorrect and
try to fix it. Once you have solved the problem, make a note of the error and
the solution for resolving it. Re-save your program and then build it again by
re-running the \gradlebuild{}. You should keep revising the implementation of
...
\section*{Checking the Correctness of Your Program and Test Suite}
...
your assignment, checking to see if it meets all of the requirements. If your
Java source code meets all of the established requirements, then you will see a
green \checkmark{} in the listing of commits in GitHub after awhile. If your
...
code and comments, as further described in the \step{Evaluation} section of
this assignment sheet. Unless you provide the instructor with documentation of
the extenuating circumstances that you are facing, no late work will be
considered towards your grade for this practical assignment.
