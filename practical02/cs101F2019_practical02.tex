...
all of the programs on which it depends. Note that assignment checking will
still work with Travis CI even if you do not have these programs installed on
your laptop. Please see a teaching assistant if you cannot install these
programs.
