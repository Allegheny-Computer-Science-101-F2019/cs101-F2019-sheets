...
\begin{itemize}
  ...
  \item How to use \command{gradle} to build, run, and grade all classes in a Java program
...
\begin{itemize}
  ...
  \item How to create, catch, and handle exceptions thrown by a method in a Java program
...
\begin{itemize}
  ...
  \item How to use psuedo-random number generators in the method(s) of a Java program
...
% Extensively extended the next two chapters
% Data structures are now the focus of the next mastery quiz
...
\begin{itemize}
  ...
  \item The similarities and differences between methods using linear, binary,
    and multiple recursion
