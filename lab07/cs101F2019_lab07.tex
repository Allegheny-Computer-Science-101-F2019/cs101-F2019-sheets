...
instructor or one of the technical leaders if you have questions about these
reading assignments.
...
testing, and use.
%
Here are some of the questions that you should aim to answer during the
...
\begin{enumerate}
  ...
  \item For the chosen input sizes in the results table, which strategy is faster? How can you tell?
  ...
  \item Why is it not possible to run one of the Fibonacci computation algorithms for certain inputs?
