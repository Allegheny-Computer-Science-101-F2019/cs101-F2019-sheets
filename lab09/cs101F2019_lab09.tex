...
\newcommand{\assignmentduedate}{December 7}
\newcommand{\assignmentassignedate}{Novembr 30}
...
methods, you will continue to practice using Java and JUnit to implement and
test a data structure while using a grading tool to assess your progress towards
...
with a name like
``Allegheny-Computer-Science-101-Fall-2018/computer-science-101-fall-2018-lab-9-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-101-F2018/computer-science-101-fall-2018-lab-9-gkapfham.git
\end{lstlisting}
