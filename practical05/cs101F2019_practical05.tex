...
with a name like
``Allegheny-Computer-Science-101-Fall-2019/computer-science-101-fall-2019-practical-4-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-101-F2019/computer-science-101-fall-2019-practical-4-gkapfham.git
\end{lstlisting}
...
in the Docker container. Did you see that some of the test cases do not pass?
Can you explain why a test might fail? Can you repair the program so that all of
the test cases pass?
...
Java compiler to check your program for errors and get it ready to run. For your
reference, here are the methods for performing encryption and decryption. Before
continuing with the assignment, can you explain why they both call the same
...
If you see any error messages, go back to your text editor and figure out what
you mis-typed and fix it. You should keep revising the implementation of
...
that it better handles numbers and punctuation. Finally, can you think of a way
to change the program so that it is more maintainable?
...
your Docker container. If you have mistakes in your assignment, then you will
...
comments, as further described in the \step{Evaluation} section of this
...
of the programs on which it depends or if you use Docker. You can see these
dependencies (i.e., Gradle, Java, Markdownlint, and Python) by reading the
documentation in your GitHub repository for this assignment. Note that
assignment checking will still work with Travis CI even if you do not have these
programs installed on your laptop. Please see the instructor or technical leader
if you have trouble installing these programs.
