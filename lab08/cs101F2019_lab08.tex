...
\newcommand{\assignmentduedate}{November 21}
...
\newcommand{\testprogram}{\lstinline{TestSinglyLinkedList}}
...
You will complete a programming project using source code provided in the
textbook and by the course instructor, ultimately implementing a framework for
...
``Allegheny-Computer-Science-101-Fall-2019/computer-science-101-fall-2019-lab-8-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-101-F2019/computer-science-101-fall-2019-lab-8-gkapfham.git
\end{lstlisting}
