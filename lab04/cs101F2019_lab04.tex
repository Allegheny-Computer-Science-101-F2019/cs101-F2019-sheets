...
\newcommand{\assignmentduedate}{October 11}
...
you complete this laboratory assignment, your goal is to proceed incrementally,
adding the required code and then checking to see if an additional test passes.
Once a new feature is working, please make sure that you commit your code with
