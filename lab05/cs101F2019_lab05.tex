...
commentary for Table 4.1. Please see the instructor or one of the technical
leaders if you have questions about this reading assignment.
...
``Allegheny-Computer-Science-101-Fall-2019/computer-science-101-fall-2019-lab-5-gkapfham''.
...
\begin{lstlisting}
  git clone git@github.com:Allegheny-Computer-Science-101-F2019/computer-science-101-fall-2019-lab-5-gkapfham.git
\end{lstlisting}
...
%
Page 172 also includes the following statement about the performance of {\tt
  repeat2}: ``the running times in that table $\ldots$ demonstrate a trend of
  approximately doubling each time the problem size doubles.'' What would this
  observation suggest about the likely worst-case time complexity of {\tt
  repeat2}?

Remember, if you want to \step{build} your program you can type \gradlebuild{}
in your Docker container, thereby causing the Java compiler to check your
program for errors and get it ready to run. If you notice that some of the tests
do not pass, please improve your implementation until all of the tests pass and
your program's output looks similar to that which is provided in
...
Markdown writing language. To complete this part of the assignment, you should
write multiple paragraphs that report on your experiences, additionally
presenting and analyzing the results from your experiments with the two sorting
algorithms. Your \reflection{} file should also have answers to the questions
about \mainprogram{}'s implementation, testing, and use.

% You can learn more about Markdown by viewing the
% aforementioned GitHub guide.
...
run the provided JUnit tests, check to ensure that the source code files contain
...
for this laboratory assignment is checking that all of the provided tests
correctly pass and that your program produces reasonable experimental results
that you can carefully explain in the context of the provided source code for
...
assignment sheet. Unless you provide the course instructor with documentation of
...
\item Stored in a Markdown file called \reflection{}, a multiple-paragraph
  response, for each of the stated questions. Along with answering all of the
  technical and scientific questions and giving the output from running your
  test suite, make sure to include the requested results in a fenced code block.
  Don't forget to carefully analyze and interpret the results!
...
\item A properly documented and correct version of all the Java source files
  ...
  %
  Please recall that you should not perform your experiments until all of the
  test cases are passing and you are confident that your program correctly times
  the sorting algorithms.
